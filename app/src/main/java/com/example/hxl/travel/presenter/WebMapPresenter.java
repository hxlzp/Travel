 ...
 */
public class WebMapPresenter extends RxPresenter implements WebMapContract.Presenter{
    WebMapContract.View mView;
    private String url = "http://112.12.36.86:8008/travel_app/html/scenic_map.html";
    private final Context webMapContext;
    ...
    public WebMapPresenter(WebMapContract.View view){
        mView = Preconditions.checkNotNull(view);
        mView.setPresenter(this);
        webMapContext = mView.getWebMapContext();
        sessionIdS = SharedPreferencesUtil.getSessionId(webMapContext);
        userIdS = SharedPreferencesUtil.getUserId(webMapContext);
...
//        addSubscribe(subscribe);
    ...
    public void getTabData() {
        String[] tabs = webMapContext.getResources().getStringArray(R.array.mapTab);
