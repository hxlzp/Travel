...
import com.example.hxl.travel.presenter.contract.WebMapContract;
 ...
 */
public class WebMapView extends RootView<WebMapContract.Presenter> implements
        WebMapContract.View,View.OnClickListener, CardPagerAdapter.OnCardItemClickListener,
        AMapLocationListener, AMap.OnMyLocationChangeListener,
        MusicService.OnMusicListener, AdapterView.OnItemClickListener, CompoundButton.OnCheckedChangeListener {
    @BindView(R.id.web_map)
    WebView webView;
    @BindView(R.id.btn_activity_back_web_title)
    Button titleBtn;
    ...
    /*适配器*/
    private MapServiceListAdapter mapServiceListAdapter;
    /*定位好友*/
    ...
    public WebMapView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void getLayout() {
        inflate(mContext, R.layout.activity_web_map_view, this);
    }
    ...
    protected void initView() {
        ...
        //获得传值
        Intent intent = ((WebMapActivity) mContext).getIntent();
    ...
    private void initScenicPopupWindow() {
        ...
        scenicPopupWindow = new PopupWindow(view, ScreenUtil.getScreenWidth(mContext) - ScreenUtil.dip2px(mContext,80),
...
//            mPresenter.getServicePointResources(service_point_id);
    ...
    private void showPicture() {
        int mWidth = getWidth()-ScreenUtil.dip2px(mContext,10);
    ...
    public void showTabData(List<ScenicList> tabs) {
        mapServiceListAdapter = new MapServiceListAdapter(mContext,tabs);
        listView.setAdapter(mapServiceListAdapter);
    ...
    @Override
    public Context getWebMapContext() {
        return mContext;
    }

    @Override
    public void setWebMapMessage(String message) {
        ToastUtil.showToast(mContext,message);
    }

    @Override
    public void setPresenter(WebMapContract.Presenter presenter) {
    ...
    /*点击事件*/
    @OnClick({R.id.iv_activity_back,R.id.iv_map_switch,
                R.id.iv_map_server,R.id.iv_map_location,
            R.id.iv_map_music_control,R.id.iv_map_footprint,R.id.iv_map_help,
            R.id.iv_map_my_location,R.id.iv_map_big,R.id.iv_map_small})
    @Override
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.iv_activity_back:
                ((WebMapActivity) mContext).finish();
                ((WebMapActivity) mContext).overridePendingTransition(android.R.anim.fade_in,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        mapServiceListAdapter.setCurrentPosition(position);
        mapServiceListAdapter.notifyDataSetChanged();
    }
    /*checkBox监听*/
    @Override
