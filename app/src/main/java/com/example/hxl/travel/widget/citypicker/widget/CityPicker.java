package com.example.hxl.travel.widget.citypicker.widget;
...
import com.example.hxl.travel.widget.citypicker.adapter.ArrayWheelAdapter;
import com.example.hxl.travel.widget.citypicker.bean.CityModel;
import com.example.hxl.travel.widget.citypicker.bean.DistrictModel;
import com.example.hxl.travel.widget.citypicker.bean.ProvinceModel;
import com.example.hxl.travel.widget.citypicker.util.XmlParserHandler;
import com.example.hxl.travel.widget.citypicker.widget.Listener.OnWheelChangedListener;
...
public class CityPicker implements CanShow, OnWheelChangedListener {
     ...
     * 第一次默认得显示，一般配合定位，使用
     */
    private String defaultDistrict = "下城区";
    /**
     * 两级联动
     */
    ...
    public CityPicker(Builder builder) {
        ...
        popview = layoutInflater.inflate(R.layout.pop_city_picker, null);
    ...
    private void setUpData() {
        ...
        ArrayWheelAdapter arrayWheelAdapter = new ArrayWheelAdapter<String>(context,
                mProvinceDatas);
                ...
                for (int j = 0; j < cityList.size(); j++) {
                    ...
                    for (int k = 0; k < districtList.size(); k++) {
                        ...
                        DistrictModel districtModel =
                                new DistrictModel(districtList.get(k).getName());
