package com.example.hxl.travel.widget.citypicker.widget.wheel;
...
import com.example.hxl.travel.widget.citypicker.adapter.WheelViewAdapter;
import com.example.hxl.travel.widget.citypicker.widget.Listener.OnWheelChangedListener;
import com.example.hxl.travel.widget.citypicker.widget.Listener.OnWheelClickedListener;
import com.example.hxl.travel.widget.citypicker.widget.Listener.OnWheelScrollListener;
...
public class WheelView extends View {
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        ...
        // TODO: make it static
        itemsLayout.setLayoutParams(new
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.provinceLineBorder));
        // 设置线宽
